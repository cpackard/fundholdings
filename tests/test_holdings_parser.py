...
class TestGet13FHoldings(unittest.TestCase):
    ...
    def test_short_tag(self):
        ...
        self.assertEqual('infoTable', parser.short_tag(tag))
    ...
    def test_tags_and_vals(self):
        ...
        result = parser.tags_and_vals(xml.etree.ElementTree.fromstring(infoTable))
    ...
    def test_get_infotables(self):
        ...
        result = parser.get_infotables(xml.etree.ElementTree.fromstring(informationTable))
